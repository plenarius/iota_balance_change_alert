...
IOTA Balance Change Alert could always use more documentation, whether as part of the
official IOTA Balance Change Alert docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.7, 3.5 and 3.6, and for PyPy. Check
   https://travis-ci.org/plenarius/iota_balance_change_alert/pull_requests
